...
columns = ['TeamName', 'ForceVector', 'ExpSP', 'SF']
...
print("Non-Hammer Efficiency for Men's 2020 OOM teams, 15 games minimum")
print("ForceVector: probability vector for team's performance without the hammer")
print("Scoring environment: " + str(league_vector) + " is the probability vector for an average end in the league")
print("Read vectors as [ 3+ pct, 2 pct, 1 pct, -1+ pct, 0 pct]")
print('\n')
print(report)
