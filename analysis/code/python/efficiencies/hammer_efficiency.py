...
columns = ['TeamName', 'HammerVector', 'ExpHP', 'HF']
...
print("Hammer Efficiency for Men's 2020 OOM teams, 15 games minimum")
print("HammerVector: probability vector for team's performance with the hammer")
